...
Then, the package can be installed into your computer by executing:

```{r eval=FALSE}
install.packages("LOYdata_0.0.99.tar.gz", repos=NULL, 
                 type="source")
```
...
```{r, check_sex}
dd <- dir(rawDataPath, full.names=TRUE)[1:10]
sex <- checkSex(dd)
